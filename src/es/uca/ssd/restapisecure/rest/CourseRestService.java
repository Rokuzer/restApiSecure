...
public class CourseRestService {
	...
	@Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	public Response updateCourse(@HeaderParam("name") String name, @HeaderParam("idUser") String id,
			@HeaderParam("apikey") String apikey, @HeaderParam("idCourse") Integer idCourse) throws Exception {
		try {
			...
			if (User != null && User.getApiKey().equals(apikey)) {
				...
				if (course != null) {
					...
					return Response.ok("the course has been update.").header("X-Content-Type-Options", "nosniff")
							.build();
				} else {
